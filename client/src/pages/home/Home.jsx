import flagImg1 from '../../assets/images/flags/eng.png';
import flagImg2 from '../../assets/images/flags/fra.png';
            ...
            <div className='container'>
              <div className='header-left mr-md-4'>
                <a
                  ...
                  aria-label='menu-toggle'></a>
                <a
                  href='demo1.html'
                  className='logo ml-lg-0'>
                  <img
                    src={logo}
                    alt='logo'
                    width={144}
                ...
                <div className='header-left'>
                          ...
                          <ul className='megamenu'>
                            ...
                            <li>
                              <div className='menu-banner banner-fixed menu-banner4'>
                                ...
                                <div className='banner-content'>
                                  <h4 className='banner-subtitle font-weight-normal'>Deals Of The Week</h4>
                                  <h3 className='banner-title text-white'>Save On Smart EarPhone</h3>
                                  <div className='banner-price-info text-secondary font-weight-bolder text-uppercase text-secondary'>20% Off</div>
                                  <a
                                    href='shop-banner-sidebar.html'
                              ...
                              <div className='col-6'>
                                <div className='banner banner-fixed menu-banner5 br-xs'>
                                  ...
                                  <div className='banner-content text-right y-50'>
                                    <h4 className='banner-subtitle font-weight-normal text-default text-capitalize'>New Arrivals</h4>
                                    <h3 className='banner-title font-weight-bolder text-capitalize ls-normal'>Amazing Sofa</h3>
                              ...
                              <div className='col-6'>
                                <div className='banner banner-fixed menu-banner5 br-xs'>
                                  ...
                                  <div className='banner-content y-50'>
                                    <h4 className='banner-subtitle font-weight-normal text-white text-capitalize'>Best Seller</h4>
                                    <h3 className='banner-title font-weight-bolder text-capitalize text-white ls-normal'>Chair &amp; Lamp</h3>
                  ...
                  <nav className='main-nav'>
                    <ul className='menu active-underline'>
                      ...
                      <li>
                        <a href='vendor-dokan-store.html'>Cart</a>
                      </li>
                      <li>
                        <a href='vendor-dokan-store.html'>Checkout</a>
                      </li>
